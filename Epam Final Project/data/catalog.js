var catalog = [{
    ...
    colors: [],
    sizes: [],
    thumbnail: 'pullover1.png', // replace with path to image extracted from catalog layout
    preview: './img/' // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Black', 'White'],
    sizes: ['UK 18'],
    thumbnail: 't-shirt1.png', // replace with image extracted from item layout
    preview: './img/' // replace with paths to images extracted from item layout
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'hoody.png', // replace with image extracted from item layout
    preview: './img/' // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: 'jeans.png', // replace with image extracted from item layout
    preview: './img/' // replace with paths to images extracted from item layout
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'dress.png', // replace with image extracted from item layout
    preview: './img/' // replace with paths to images extracted from item layout
}, {
    ...
    thumbnail: ['full.png','thumb_0.png','thumb_1.png','thumb_2.png'], // replace with image extracted from item layout
    preview: './img/' // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Green'],
    sizes: ['UK 19'],
    thumbnail: 'suit2.png', // replace with image extracted from item layout
    preview: './img/'  // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 17'],
    thumbnail: 't-shirt.png', // replace with image extracted from item layout
    preview: './img/' // replace with paths to images extracted from item layout
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'suit.png', // replace with image extracted from item layout
    preview: './img/' // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Dark Blue'],
    sizes: ['UK 19'],
    thumbnail: 'pullover2.png', // replace with image extracted from item layout
    preview: './img/' // replace with paths to images extracted from item layout
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'pullover.png', // replace with image extracted from item layout
    preview: './img/' // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 18', 'UK 19'],
    thumbnail: 't-shirt2.png', // replace with image extracted from item layout
    preview: './img/' // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: 'top.png', // replace with image extracted from item layout
    preview: './img/' // replace with paths to images extracted from item layout
}];
